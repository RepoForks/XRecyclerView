...
public class XRecyclerView extends RecyclerView {
    ...
    private boolean pullRefreshEnabled = true; //下拉刷新开关
    private boolean loadingMoreEnabled = true; //上拉刷新开关
    ...
    public void setAdapter(Adapter adapter) {
        ...
        //将包裹了 footer 和 header的adapter 传递个recyclerView 处理
    ...
    /**
     * 继承 RecyclerView.Adapter 是为了将Header 和 footer 默认加入到adapter中
     */
    private class WrapAdapter extends RecyclerView.Adapter<ViewHolder> {
        ...
        /**
         * 构造函数 传递 header 和 footer
         * @param headerViews 头部
         * @param footViews  尾部
         * @param adapter 实际的adapter
         */
        ...
        public void onAttachedToRecyclerView(RecyclerView recyclerView) {
            ...
            if (manager instanceof GridLayoutManager) { //其实这个判断加否都没影响
                final GridLayoutManager gridManager = ((GridLayoutManager) manager);
                //调整header 和 footer的宽度为整行
